					...
					<body class='white'>
						...
						<nav class='blue' role='navigation'>
							<div class='nav-wrapper container'>
								...
								<form action='' method='POST'>
									<input type='submit' class='left waves-effect waves-green btn-flat white-text' value='Salir' name='bye'/>
								</form>
							</div>
						</nav>
						<!--Cuerpo de la página-->
						...
						<!--Introduccion-->
							...
							<div class='row'>
								<div class='col l12'>
									<br/>
									<h1>Registra una nueva especie</h1>
									<br/>
									<h5>Los marcados con asterisco (*) son campos opcionales</h5>
